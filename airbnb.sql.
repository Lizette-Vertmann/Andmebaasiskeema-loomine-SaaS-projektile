...
CREATE TABLE `hosts` (
  ...
  `user_id` int(11) NOT NULL COMMENT 'Seos kasutajaga',
  `name` varchar(255) DEFAULT NULL COMMENT 'Hosti nimi',
  ...
  `email` varchar(255) DEFAULT NULL COMMENT 'Kontakt email',
...
CREATE TABLE `listings` (
  ...
  `city` varchar(255) DEFAULT NULL COMMENT 'Linn',
  `price` decimal(10,2) DEFAULT NULL COMMENT 'Hind öö kohta',
  `room_type` varchar(255) DEFAULT NULL COMMENT 'Tuba',
...
CREATE TABLE `reviews` (
  ...
  `reviewer_name` varchar(255) DEFAULT NULL COMMENT 'Arvustaja nimi',
  ...
  `reviewer_id` int(11) UNSIGNED DEFAULT NULL COMMENT 'Arvustaja ID',
  `reply` text DEFAULT NULL COMMENT 'Hosti vastus',
...
CREATE TABLE `bookings` (
  ...
  `user_id` int(11) NOT NULL COMMENT 'Külalise ID',
  `listing_id` int(11) UNSIGNED NOT NULL COMMENT 'Majutuse ID',
  `check_in` date NOT NULL,
  `check_out` date NOT NULL,
  `guests` int(11) NOT NULL COMMENT 'Külaliste arv',
